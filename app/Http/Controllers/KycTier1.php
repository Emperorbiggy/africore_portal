...
class KycTier1 extends Controller
{
    ...
    public function kycTier1(Request $request)
    {
        ...
        try {
            ...
            // Create Tier 1 customer
            $response = Http::withHeaders([
                'Authorization' => 'Bearer ' . $this->secretKey,
                'Accept' => 'application/json',
                'Content-Type' => 'application/json',
            ])->post('https://sandbox.api.maplerad.com/v1/customers', [
            ...
            Log::info('Create Customer Response:', $responseData);

            if (!isset($responseData['status']) || !$responseData['status']) {
                return response()->json(['error' => 'Customer creation failed', 'details' => $responseData], 400);
            }
